...
test("get_ch_calendar 2026", function(){
    $cal = \scalp\get_ch_calendar(2026);
    expect($cal->getTimezone())->toBe("CET");
    expect($cal->getCountryCode())->toBe("CH");
    ...
    expect($cal->isMarkedClosed("2026-01-02"))->toBeTruthy();
    ...
    expect($cal->isMarkedClosed("2026-08-01"))->toBeTruthy();
